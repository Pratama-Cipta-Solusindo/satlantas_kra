                        ...
                        $.each(line, function() {
                            ...
                            switch (this[0]) {
                                case 'shift':
                                    ...
                                    btn.addClass('jqbtk-shift').html('<i class="fa fa-arrow-up" aria-hidden="true"></i>');
                                    break;
                                case 'space':
                                    //btn.addClass('jqbtk-space').html('&nbsp;');
                                    btn.addClass('jqbtk-space').html('[ Spasi ]');
                                    break;
                                case 'del':
                                    //btn.addClass('jqbtk-del').html('<span class="glyphicon glyphicon-arrow-left"></span>');
                                    btn.addClass('jqbtk-del').html('<i class="fa fa-arrow-left" aria-hidden="true"></i>');
                                    break;
                                case 'enter':
